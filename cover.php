...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><strong style="color:red"> Niskize Counselling Center Online Appointment Booking System</strong></a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:50%;left:50%;background-color:blue">Login</button>
